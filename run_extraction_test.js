 ...
 * Programmatically creates a test project, uploads the controlled document,
 * chunks it, and invokes the extract-knowledge Edge Function.
 * Captures LLM output and database state before/after.
 */
