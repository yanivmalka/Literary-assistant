    ...
    return (
      <div className="relative min-h-screen flex items-center justify-center bg-background p-4">
        ...
        <div className="w-full max-w-md text-center">
          ...
          <h2 className="font-display text-xl font-semibold mb-4">{t('ui.auth.confirmationTitle')}</h2>
    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-md">
        ...
        <div className="border border-border rounded-2xl p-7 bg-card shadow-sm">
          <h2 className="font-display text-lg font-semibold mb-6 text-center">{t('auth.signup')}</h2>
